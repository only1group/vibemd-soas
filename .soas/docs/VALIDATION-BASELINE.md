...
| F — standards resolution | `ISO-31000`, `ISO-22301` and `ISO-9241` were referenced but absent; no other unregistered normative IDs were found. | Accepted and bounded to the three observed IDs. | Add entries and reproducibility metadata; lint every mapping. | Additive registry contract; metadata fields now required. |
